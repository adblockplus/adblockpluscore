...
/**
 * Similar to `{@link module:content/snippets.log log}`, but does the logging
...
/**
 * Create an object with `mark()` and `end()` methods to either keep marking
 * a specific profiled name, or ending it.
 *
 * @example
