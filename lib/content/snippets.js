...
function watchElement(selector, options = "") {
  ...
  function searchElement() {
    ...
    for (let object of objects) {
      if (object) {
        const desc = Object.getOwnPropertyDescriptor(object, propertiesList[0]);
        if (desc) break;
        for (let property of propertiesList) attach(object, property);
        if (subtree) {
          //listen to this object mutations and attach
  ...
  observer = new MutationObserver(searchElement);
  ...
  function attach(object, property, isChild = false) {
    ...
    wrapPropertyAccess(object, property, descriptor);
          ...
          return {
            get() {
              return (...args) => {
                ...
                const parent = insideTarget ? this : this.parentElement;
                if (
                  (subtree && isChild) ||
                  (subtree && !isChild && insideTarget) ||
                  (!subtree && isChild && !insideTarget) ||
                  (!subtree && !isChild && insideTarget)
                ) {
