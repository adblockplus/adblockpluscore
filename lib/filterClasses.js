 ...
 * @augments Filter
 */
exports.InvalidFilter = function(text, reason)
{
 ...
 * @augments Filter
 */
exports.CommentFilter = function(text)
{
  Filter.call(this, text);
};
 ...
 * @augments Filter
 */
exports.ActiveFilter = function(text, domains)
{
  Filter.call(this, text);
 ...
 */
exports.RegExpFilter = function(text, regexpSource, contentType, matchCase,
                                domains, thirdParty, sitekeys, rewrite)
{
 ...
 */
exports.BlockingFilter = function(text, regexpSource, contentType, matchCase,
                                  domains, thirdParty, sitekeys, rewrite, csp)
{
 ...
 * @augments RegExpFilter
 */
exports.WhitelistFilter = function(text, regexpSource, contentType, matchCase,
 ...
 * @augments ActiveFilter
 */
exports.ContentFilter = function(text, domains, body)
{
 ...
 */
exports.ElemHideBase = function(text, domains, selector)
{
 ...
 */
exports.ElemHideFilter = function(text, domains, selector)
{
 ...
 * @augments ElemHideBase
 */
exports.ElemHideException = function(text, domains, selector)
{
  ElemHideBase.call(this, text, domains, selector);
};
 ...
 * @augments ElemHideBase
 */
exports.ElemHideEmulationFilter = function(text, domains, selector)
{
  ElemHideBase.call(this, text, domains, selector);
};
 ...
 * @augments ContentFilter
 */
exports.SnippetFilter = function(text, domains, script)
{
