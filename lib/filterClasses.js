 ...
 * @type {?string}
 */
URLFilter.prototype.header = null;
...
exports.BlockingFilter = class BlockingFilter extends URLFilter
{
   ...
   *
   * @param {Headers} headers the HTTP response headers to match, as
   *   they are returned by the request blocker. They follow the
   *   {@link fetch API https://developer.mozilla.org/en-US/docs/Web/API/Headers}.
