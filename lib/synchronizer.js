...
class Synchronizer {
  ...
  constructor(filterStorage) {
    ...
    DownloadableSubscription.useSynchronizer(this);
  }
   ...
   * @param {module:subscriptionClasses.DownloadableSubscription
   *   |module:subscriptionClasses.NonDownloadableSubscription} subscription
  ...
  execute(subscription, manual) {
    subscription.getDownloader(this).download(
      this._getDownloadable(subscription, manual));
  }
