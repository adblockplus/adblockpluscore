 ...
 */
exports.domainSuffixes = function* (domain, includeBlank = false)
{
  while (domain != "")
  {
    yield domain;
 ...
 * @returns {boolean}
 */
exports.isThirdParty = function(requestHostname, documentHostname)
{
 ...
 * @package
 */
exports.parseDomains = function(source, separator)
{
