 ...
 *
 * This is a lightweight alternative to the native `URL` object. Unlike the
 * `URL` object, this function is not robust and will give incorrect results
 * for invalid URLs. _Use this function with valid, normalized, properly
 * encoded (IDNA and percent-encoding) URLs only._
 *
