...
class Recommendation {
   ...
   * @type {?Array.<string>} the id of the required subscriptions.
   */
  get requires() {
...
/**
 * Set the recommendations. This will override the provided ones. It
 * should be done before any other operation on subscriptions, and
