...
class Notifications extends EventEmitter {
  ...
  start() {
    ...
    console.log(new Date(), "Core Notifications: starting scheduled checks for notifications");
  ...
  *_getDownloadables() {
  ...
  _onDownloadSuccess(downloadable, responseText, errorCallback,
                     redirectCallback) {
    try {
      console.log("Notifications downloaded successfully");
  ...
  _onDownloadError(downloadable, downloadURL, error, responseStatus,
                   redirectCallback) {
    console.log("Notifications downloaded failed");
  ...
  shouldIgnoreNotifications() {
    console.log(new Date(), "Checking shouldIgnoreNotifications", Prefs.notifications_ignoredcategories);
    return this.ignored ||
  ...
  toggleIgnoreCategory(category, forceValue) {
    console.log(new Date(), "Toggling ignore category", category, forceValue);
   ...
   */
  getDownloadCount() {
    console.log("Fetching downloadCount", Prefs.notificationdata.downloadCount);
  ...
  getIgnoredCategories() {
    console.log(new Date(), "Getting ignored categories", Prefs.notifications_ignoredcategories);
