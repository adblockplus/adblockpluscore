 ...
 * @constructor
 */
exports.Subscription = function(url, title)
{
  this.url = url;
 ...
 */
exports.SpecialSubscription = function(url, title)
{
 ...
 * @augments Subscription
 */
exports.RegularSubscription = function(url, title)
{
 ...
 */
exports.ExternalSubscription = function(url, title)
{
 ...
 * @augments RegularSubscription
 */
exports.DownloadableSubscription = function(url, title)
{
  RegularSubscription.call(this, url, title);
};
