 ...
 * used.
 *
 * If the subscription URL looks like a download URL
 * (i.e. does not begin with `~`) but is not a
 * {@link module:downloader.Downloader.isValidURL valid download URL}, the
 ...
 *
 * @throws {Error} If `url` looks like a download URL
 *   (i.e. does not begin with `~`) but is not a
 *   {@link module:downloader.Downloader.isValidURL valid download URL}.
 */
