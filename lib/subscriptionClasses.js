...
exports.Subscription.fromObject = function(obj) {
  ...
  if (obj.url[0] != "~") {
    ...
    if ("id" in obj)
      result.id = obj.id;
    if ("updatable" in obj)
      result.updatable = obj.updatable;
...
class DownloadableSubscription extends RegularSubscription {
  ...
  constructor(url, title) {
    ...
    /**
     * The id of non updatable subscription.
     * @type {?string}
     * @default <code>null</code>
     * @see module:subscriptionClasses.DownloadableSubscription#id
     */
    this.id = null;

    /**
     * The flag that the subscriptions is updatable.
     * @type {?boolean}
     * @default <code>true</code>
     * @see module:subscriptionClasses.DownloadableSubscription#updatable
     */
    this.updatable = true;

    /**
     * The content of non updatable subscription
     * @type {?string}
     * @default <code>null</code>
     * @see module:subscriptionClasses.DownloadableSubscription#content
     */
    this.content = null;
  ...
  *serialize() {
    let {downloadStatus, lastSuccess, lastCheck, expires,
         ...
         downloadCount, id, updatable} = this;
