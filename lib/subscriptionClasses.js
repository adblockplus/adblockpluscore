...
/**
 * The `ExternalSubscription` class represents a regular filter subscription
 * that is updated externally (by another brower extension).
 */
exports.ExternalSubscription =
class ExternalSubscription extends RegularSubscription
{
  /**
   * Creates an `ExternalSubscription` object.
   * @param {string} url The URL of the subscription.
   * @param {string} [title] The title of the subscription.
   * @private
   */
   ...
   * Serializes the subscription for writing out on disk.
   *
   * __Note:__ An external subscription should not be serialized. This method
