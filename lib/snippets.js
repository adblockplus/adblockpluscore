 ...
 *  executable code.
 * @param {string|Array.<string>} libraries An already stringified array of
 *  strings, or an array of strings. Strings are libraries used once compiled.
...
exports.compileScript = function compileScript(scripts,
                                               libraries,
                                               environment = {}) {
  let libs = typeof libraries === "string" ?
